...
def main():
    ...
    """
    if m1_tests.is_implemented('__init__', 0):
        test_init()
...
class CircleChanger(object):
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        dis = self.circle.center.get_distance_from(point)
        return dis
    ...
    def swallow(self, other_circle_changer):
        ...
        return CircleChanger(center.x, center.y, radius, 'red', colors)
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.circle.oric
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.circle.count % len(self.colors)]
        self.circle.count = self.circle.count + 1
