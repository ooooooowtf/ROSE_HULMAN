...
def double_a_float():
    ...
    # ------------------------------------------------------------------
    number = float(input('input floating point number')) * 2
    print (number)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # ------------------------------------------------------------------
    posnum = float(input('a positive floating point number'))
    posint = int(input('a positive integer'))
    posstr = input('a string')
    for _ in range(posint):
        print(posnum)
