...
def test_practice_problem2a():
    ...
    # Test 2
    print('Expected:[2, 10, 5, -20, 8, 10, 20]')
    print('Actual  ', practice_problem2a([-4, 4, -1, -26, 2, 4, 14], 6))

    # Test 3
    print('Expected:[10, 10, 10, 10, 10]')
    print('Actual  ', practice_problem2a([4, 4, 4, 4, 4], 6))
    # Test 4
    print('Expected:[0, 0, 0, 0, 0]')
    print('Actual  ', practice_problem2a([-4, -4, -4, -4, -4], 4))
