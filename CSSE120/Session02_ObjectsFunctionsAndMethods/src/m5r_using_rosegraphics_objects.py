...
#            rectangle1 = rg.Rectangle(length, 100)
#
...
#                attach_to(),move_center_to(), move_by()
#
...
#            Updates all the Shapes attached to then draws all those Shapes.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            if we dont call that method, the window will pop out and close.
#
