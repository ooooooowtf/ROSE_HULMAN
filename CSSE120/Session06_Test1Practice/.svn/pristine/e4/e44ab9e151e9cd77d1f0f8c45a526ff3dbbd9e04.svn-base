...
def test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (40, 40), 12 lines'
...
def problem3b(m, point1):
    ...
    numsum = 0
    for k in range(m):
        numsum = numsum + problem3a(window4, point1, 3 + 2 * k)
        point1.x = point1.x - 20 * (3 + 2 * k)
        point1.y = point1.y + 60 - (3 + 2 * k) * 10
