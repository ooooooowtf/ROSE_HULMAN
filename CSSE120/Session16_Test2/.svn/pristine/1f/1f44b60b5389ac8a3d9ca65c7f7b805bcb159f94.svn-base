...
def test_problem1a():
    ...
    print('\n' + 'Test 8:')
    expected = -9
    actual = problem1a([1, 1, 1, 1, 1, 1, 1, 1, 1], 2)
    print("Expected:", expected)
    print("Actual:", actual)
    if expected == actual:
        print("Test passed SUCCESSFULLY!")
...
def problem1a(golf_scores, par):
    ...
    # ------------------------------------------------------------------
    n = 0
    if len(golf_scores) == 9:
        for k in range(9):
            n = n + golf_scores[k] - par
...
def problem1b(circles, z):
    ...
    for k in range(len(circles)):
        if circles[k].radius < z:
            return circles[k].radius
