...
public class BasketballUtility {
	...
	// This ensures that the results of random events are deterministic and
	// repeatable
	public static final long RANDOM_SEED = 1000;

	// This creates an Object of type Random which has methods to return random
	// values
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			System.out.printf("Generated %.2f compared to accuracy of %.2f: ", num, accuracy);
			if (num < accuracy) {
