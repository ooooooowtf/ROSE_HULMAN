...
public class MapAnd2DArrayProblemsTest {
	...
	public void testZeroDiagonals() {
		...
		int[][] test3 = { { 0, 1, 2 }, { 2, 3, 7 }, { 4, 5, 8 } };
		int[][] expected3 = { { 0, 1, 0 }, { 2, 0, 7 }, { 0, 5, 0 } };
		MapAnd2DArrayProblems.zeroDiagonals(test3);
		assertArrayEquals(expected3, test3);

		int[][] test4 = { { 1, 1, 2, 3 }, { 5, 8, 1, 3 }, { 2, 1, 3, 4 }, { 5, 5, 8, 9 } };

		int[][] expected4 = { { 0, 1, 2, 0 }, { 5, 0, 0, 3 }, { 2, 0, 0, 4 }, { 0, 5, 8, 0 } };
		MapAnd2DArrayProblems.zeroDiagonals(test4);
		assertArrayEquals(expected4, test4);

		int[][] test5 = { { 1, 0, 3, 0, 0 }, { 1, 1, 2, 0, 0 }, { 1, 1, 6, 1, 0 }, { 3, 4, 7, 5, 6 },
				{ 3, 6, 2, 1, 3 } };

		int[][] expected5 = { { 0, 0, 3, 0, 0 }, { 1, 0, 2, 0, 0 }, { 1, 1, 0, 1, 0 }, { 3, 0, 7, 0, 6 },
				{ 0, 6, 2, 1, 0 } };
